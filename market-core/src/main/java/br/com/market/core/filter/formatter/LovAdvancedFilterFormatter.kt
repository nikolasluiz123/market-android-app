...
/**
 * Implementação da interface [IAdvancedFilterFormatter] que formata um par (Pair) para um filtro avançado.
 *
 ...
 *
 * @constructor Cria uma instância de [LovAdvancedFilterFormatter].

 ...
 *
 * Esta classe base implementa a interface [IAdvancedFilterFormatter] e fornece uma formatação
 * simples para valores do tipo String, removendo espaços em branco no início e no final.
 *
 * @constructor Cria uma instância de [StringAdvancedFilterFormatter].

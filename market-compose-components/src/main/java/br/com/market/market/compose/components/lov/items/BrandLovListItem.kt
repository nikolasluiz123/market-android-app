...
@Composable
fun BrandLovListItem(brandName: String, onItemClick: () -> Unit = { }) {
    ConstraintLayout(
        modifier = Modifier
            .fillMaxWidth()
            .padding(8.dp)
        ...
        LabeledText(
            ...
            label = stringResource(id = R.string.brand_lov_label_name),
            value = brandName
        )
    }
}
...
@Composable
fun BrandLovListItemPreview() {
    MarketTheme {
        Surface {
            BrandLovListItem("Nestle")
        }
    }
}
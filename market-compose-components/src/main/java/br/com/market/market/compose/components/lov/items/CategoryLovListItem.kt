...
@Composable
fun CategoryLovListItem(name: String, onItemClick: () -> Unit = { }) {
    ConstraintLayout(
        modifier = Modifier
            .fillMaxWidth()
            .padding(8.dp)
        ...
        LabeledText(
            ...
            label = stringResource(id = R.string.category_lov_label_name),
            value = name
        )
    }
}
...
@Composable
fun CategoryLovListItemPreview() {
    MarketTheme {
        Surface {
            CategoryLovListItem("Carnes")
        }
    }
}
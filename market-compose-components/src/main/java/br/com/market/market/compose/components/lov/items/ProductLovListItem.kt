...
fun ProductLovListItem(
    ...
    ConstraintLayout(
        ...
        LabeledText(
            ...
            label = stringResource(R.string.product_lov_list_item_label_name),
            value = name
        )
        ...
        LabeledText(
            ...
            label = stringResource(R.string.product_lov_list_item_label_price),
        ...
        LabeledText(
            ...
            label = stringResource(R.string.product_lov_list_item_label_quantity),

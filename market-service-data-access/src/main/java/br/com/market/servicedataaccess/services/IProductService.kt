...
interface IProductService {
    ...
    @GET("product")
    suspend fun findAllProductDTOs(@Header("Authorization") token: String): Response<ReadResponse<ProductSDO>>

    @GET("product/images")
    suspend fun findAllProductImageDTOs(@Header("Authorization") token: String): Response<ReadResponse<ProductImageSDO>>
}